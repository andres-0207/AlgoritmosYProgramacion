Algoritmo ejercicio3_6
	...
	Leer a;
	Imprimir "Escriba el valor de b";
	Leer b;
	Imprimir "Escriba el valor de c"
	Leer c;
	Imprimir "Escriba el valor de d";
	Leer d;
	Imprimir "Escriba el valor de x";
	Leer x;
	Imprimir "Escriba el valor de y1";
	Leer y1;
	Imprimir "Escriba el valor de y2";
	Leer y2;
	Imprimir "Escriba el valor de x1";
	Leer x1;
	Imprimir "Escriba el valor de x2";
	Leer x2;
	Imprimir "Escriba el valor de z";
	Leer z;
	Imprimir "Escriba el valor de r";
	Leer r;
	Imprimir "El resultado de a) raiz(b^)-4*a*c es ", raiz(b^2)-4*a*c;
	Imprimir "El resultado de b) (x^2+y1^2)/z^2 es ", (x^2+y1^2)/z^2;
